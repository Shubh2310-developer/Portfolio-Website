...
export const skillsData: Record<SkillCategory, Skill[]> = {
  ...
  backend: [
    ...
    { name: 'REST APIs', level: 90, icon: Server, category: 'backend' },
  ],
  devops: [
  ...
  ai: [
    { name: 'Machine Learning', level: 75, icon: Cpu, category: 'ai' },
    { name: 'Deep Learning', level: 70, icon: Cpu, category: 'ai' },
  ...
  tools: [
    ...
    { name: 'Postman', level: 90, icon: Wrench, category: 'tools' },
    { name: 'MongoDB', level: 85, icon: Database, category: 'tools' },
    { name: 'PostgreSQL', level: 80, icon: Database, category: 'tools' },
  ],
}
